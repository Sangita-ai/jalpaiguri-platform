...
exports.getWaterPipesGeoJSON = exports.getTreesGeoJSON = exports.getDrainsGeoJSON = exports.getComplaintPoints = exports.getComplaintHeatmap = exports.getWardsGeoJSON = void 0;
...
async function getWardsGeoJSON() {
    ...
    const wardStats = await prisma_1.prisma.$queryRaw `
    SELECT
      w.id             AS ward_id,
      w.ward_number,
      w.name,
...
exports.getWardsGeoJSON = getWardsGeoJSON;
// ── Complaint heatmap ─────────────────────────────────────────
async function getComplaintHeatmap() {
...
exports.getComplaintHeatmap = getComplaintHeatmap;
// ── Complaint points (clustered source data) ──────────────────
async function getComplaintPoints(filters = {}) {
    const where = {
    ...
    if (filters.from || filters.to) {
        ...
        if (filters.to)
            where.submittedAt.lte = new Date(filters.to);
    }
...
exports.getComplaintPoints = getComplaintPoints;
// ── Drain sensors ─────────────────────────────────────────────
async function getDrainsGeoJSON() {
...
exports.getDrainsGeoJSON = getDrainsGeoJSON;
// ── Trees ─────────────────────────────────────────────────────
async function getTreesGeoJSON(wardId) {
    const trees = await prisma_1.prisma.tree.findMany({
        where: wardId ? { wardId } : {},
        select: {
            id: true,
            treeCode: true,
...
exports.getTreesGeoJSON = getTreesGeoJSON;
// ── Water pipes ───────────────────────────────────────────────
async function getWaterPipesGeoJSON() {
    ...
    const sensorFeatures = pipes.flatMap(p => p.sensors.map(s => ({
        type: 'Feature',
    ...
    return {
        pipes: { type: 'FeatureCollection', features: pipeFeatures },
        sensors: { type: 'FeatureCollection', features: sensorFeatures },
    };
}
exports.getWaterPipesGeoJSON = getWaterPipesGeoJSON;
