...
exports.checkDuplicate = exports.aiTriageComplaint = void 0;
...
async function aiTriageComplaint(description, providedCategory) {
...
exports.aiTriageComplaint = aiTriageComplaint;
async function checkDuplicate(description, locationLat, locationLng, withinHours = 48) {
    if (!process.env.ANTHROPIC_API_KEY || process.env.ANTHROPIC_API_KEY.includes('your-key')) {
    ...
    try {
        ...
        const recent = await prisma_1.prisma.complaint.findMany({
            where: {
...
function mockTriage(description, providedCategory) {
